...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 rounded-modal border border-border bg-background p-6 shadow-card-hover",
        "duration-base data-[state=open]:animate-fade-up",
        className
      )}
      {...props}
    >
